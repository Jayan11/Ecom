	  ...
	  <div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav">
			...
			<li><a href="#" style="color:white">All product</a></li>
			<li><a href="#" style="color:white">My Account</a></li>
			<li><a href="#" style="color:white">Shoping Cart</a></li>
									...
									while($row_pro = mysqli_fetch_array($run_pro)){
											...
											echo"
												<div id='product_box' style='float:left'>
													...
													<img src='admin_area/product_images/$pro_image' width='400' height='350' style='margin-right:30px'/>
													
													<h4><p style='text-align:center'><b> $ $pro_price<b></p></h4>
													<p>$pro_desc</p>
													
													<a href='home.php' class='btn btn-info btn-xs'  role='button'  style='margin-left:20px'>GO BACK</a>
